...
class ColourHandler private constructor() {
    ...
    companion object {
        ...
        fun getColourObject(colourString: String) = when (colourString) {
            ...
            "TRANSPARENT" -> App.context.resources.getColor(R.color.black, null)
        ...
        fun getColorStateList(colourString: String): ColorStateList = when (colourString) {
            ...
            "Red,800" -> ColorStateList.valueOf(
                App.context.resources.getColor(
                    R.color.red_800,
                    null
                )
            )
            "Red,900" -> ColorStateList.valueOf(
                App.context.resources.getColor(
                    R.color.red_900,
                    null
                )
            )
            "Red,A100" -> ColorStateList.valueOf(
                App.context.resources.getColor(
                    R.color.red_A100,
                    null
                )
            )
            "Red,A200" -> ColorStateList.valueOf(
                App.context.resources.getColor(
                    R.color.red_A200,
                    null
                )
            )
            "Red,A400" -> ColorStateList.valueOf(
                App.context.resources.getColor(
                    R.color.red_A400,
                    null
                )
            )
            "Red,A700" -> ColorStateList.valueOf(
                App.context.resources.getColor(
                    R.color.red_A700,
                    null
                )
            ...
            "Deep Purple,50" -> ColorStateList.valueOf(
                App.context.resources.getColor(
                    R.color.deep_purple_50,
                    null
                )
            )
            "Deep Purple,100" -> ColorStateList.valueOf(
                App.context.resources.getColor(
                    R.color.deep_purple_100,
                    null
                )
            )
            "Deep Purple,200" -> ColorStateList.valueOf(
                App.context.resources.getColor(
            ...
            "Grey,300" -> ColorStateList.valueOf(
                App.context.resources.getColor(
                    R.color.grey_300,
                    null
                )
            )
            "Grey,400" -> ColorStateList.valueOf(
                App.context.resources.getColor(
                    R.color.grey_400,
                    null
                )
            )
            "Grey,500" -> ColorStateList.valueOf(
                App.context.resources.getColor(
                    R.color.grey_500,
                    null
                )
            )
            "Grey,600" -> ColorStateList.valueOf(
                App.context.resources.getColor(
                    R.color.grey_600,
                    null
                )
            )
            "Grey,700" -> ColorStateList.valueOf(
                App.context.resources.getColor(
                    R.color.grey_700,
                    null
                )
            )
            "Grey,800" -> ColorStateList.valueOf(
                App.context.resources.getColor(
                    R.color.grey_800,
                    null
                )
            )
            "Grey,900" -> ColorStateList.valueOf(
                App.context.resources.getColor(
                    R.color.grey_900,
                    null
                )
            ...
            "TRANSPARENT" -> ColorStateList.valueOf(
                App.context.resources.getColor(
                    R.color.black,
                    null
                )
        ...
        fun getColorStateList(colourFamily: String, colourIntensity: String?) = when (colourFamily) {
            ...
            "Grey" -> {
                when (colourIntensity) {
                    ...
                    "500" -> ColorStateList.valueOf(
                        App.context.resources.getColor(
                            R.color.grey_500,
                            null
                        )
                    )
                    "600" -> ColorStateList.valueOf(
                        App.context.resources.getColor(
                            R.color.grey_600,
                            null
                        )
